 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (sqr(60) * deg + min * 60 + sec) / 206264.816
...
fun thirdDigit(number: Int): Int {
    ...
    val line = digit.toString()
    return line[line.length - 1].digitToInt()
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val perc = 1 + (percent / 100.0)
    return (initial * perc) * perc * perc
}
